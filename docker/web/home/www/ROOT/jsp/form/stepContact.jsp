...
<div id="candidatureFormStepContact" class="formTunnelBloc" style="display:none;">
  ...
  <div>
    ...
    <p>Renseignez les informations de contact dont vous disposez : <span class="badge tooltipster" title="Ce service n'enverra pas de messages à vos contacts" style="float: right;">?</span></p>
  </div>

  <div >
    <div class="formBloc" >

      <div id="nomContactTunnel"></div>

      <div id="emailContactTunnel"></div>

      <div id="telContactTunnel"></div>
  ...
  <div class="formButtons">
    <button type="button" class="btn btn-outline dark btnPrevious">Retour</button> <button type="button" class="goToForm btn green">Etape suivante</button>
    <br /><br />
  </div>
