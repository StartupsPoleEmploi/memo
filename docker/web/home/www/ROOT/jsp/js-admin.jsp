...
<pack:script>
    ...
    <src>/assets/global/plugins/morris/morris.min.js</src>
    ...
    <src>/assets/pages/scripts/dashboard.min.js</src>
    <src>/assets/layouts/layout7/scripts/layout.min.js</src>
    <src>/assets/layouts/global/scripts/quick-sidebar.min.js</src>
