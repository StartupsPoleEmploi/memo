...
CREATE TABLE `attachmentFiles` (
  ...
  KEY `md5` (`md5`),
  KEY `userId` (`userId`)
) ENGINE=InnoDB AUTO_INCREMENT=39467 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=64139 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=3954677 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=2470285 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `userLogs` (
  ...
  KEY `userId` (`userId`),
  KEY `action` (`action`)
) ENGINE=InnoDB AUTO_INCREMENT=12715897 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `users` (
  ...
  UNIQUE KEY `peId_UNIQUE` (`peId`),
  KEY `cohorteIdx` (`cohorte`),
  KEY `sourceIdx` (`source`)
) ENGINE=InnoDB AUTO_INCREMENT=279101 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
/*!50106 CREATE*/ /*!50117 DEFINER=`root_memo`@`%`*/ /*!50106 EVENT `create_statsUsersAssidus_m` ON SCHEDULE EVERY 1 DAY STARTS '2018-01-09 02:01:00' ON COMPLETION NOT PRESERVE ENABLE DO CREATE TABLE statsUsersAssidus_m AS 
...
/*!50003 SET @saved_time_zone      = @@time_zone */ ;;
/*!50003 SET time_zone             = 'SYSTEM' */ ;;
/*!50106 CREATE*/ /*!50117 DEFINER=`root_memo`@`%`*/ /*!50106 EVENT `create_statsUsersEntretien_m` ON SCHEDULE EVERY 1 DAY STARTS '2018-01-10 02:02:00' ON COMPLETION NOT PRESERVE ENABLE DO CREATE TABLE statsUsersEntretien_m AS 
...
/*!50003 SET @saved_time_zone      = @@time_zone */ ;;
/*!50003 SET time_zone             = 'SYSTEM' */ ;;
/*!50106 CREATE*/ /*!50117 DEFINER=`root_memo`@`%`*/ /*!50106 EVENT `create_statsUsersRetourEmploi_m` ON SCHEDULE EVERY 1 DAY STARTS '2018-01-10 02:03:00' ON COMPLETION NOT PRESERVE ENABLE DO CREATE TABLE statsUsersRetourEmploi_m AS 
...
/*!50003 SET @saved_time_zone      = @@time_zone */ ;;
/*!50003 SET time_zone             = 'SYSTEM' */ ;;
/*!50106 CREATE*/ /*!50117 DEFINER=`root_memo`@`%`*/ /*!50106 EVENT `create_userActivities_m` ON SCHEDULE EVERY 1 DAY STARTS '2017-10-07 01:00:30' ON COMPLETION NOT PRESERVE ENABLE DO CREATE TABLE userActivities_m AS 
...
/*!50003 SET @saved_time_zone      = @@time_zone */ ;;
/*!50003 SET time_zone             = 'SYSTEM' */ ;;
/*!50106 CREATE*/ /*!50117 DEFINER=`root_memo`@`%`*/ /*!50106 EVENT `drop_statsUsersAssidus_m` ON SCHEDULE EVERY 1 DAY STARTS '2018-01-04 02:00:00' ON COMPLETION NOT PRESERVE ENABLE DO DROP TABLE IF EXISTS statsUsersAssidus_m */ ;;
/*!50003 SET time_zone             = @saved_time_zone */ ;;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;;
/*!50003 SET character_set_client  = @saved_cs_client */ ;;
/*!50003 SET character_set_results = @saved_cs_results */ ;;
...
/*!50003 SET @saved_time_zone      = @@time_zone */ ;;
/*!50003 SET time_zone             = 'SYSTEM' */ ;;
/*!50106 CREATE*/ /*!50117 DEFINER=`root_memo`@`%`*/ /*!50106 EVENT `drop_statsUsersEntretien_m` ON SCHEDULE EVERY 1 DAY STARTS '2017-10-31 02:00:00' ON COMPLETION NOT PRESERVE ENABLE DO DROP TABLE IF EXISTS statsUsersEntretien_m */ ;;
/*!50003 SET time_zone             = @saved_time_zone */ ;;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;;
/*!50003 SET character_set_client  = @saved_cs_client */ ;;
/*!50003 SET character_set_results = @saved_cs_results */ ;;
...
/*!50003 SET @saved_time_zone      = @@time_zone */ ;;
/*!50003 SET time_zone             = 'SYSTEM' */ ;;
/*!50106 CREATE*/ /*!50117 DEFINER=`root_memo`@`%`*/ /*!50106 EVENT `drop_statsUsersRetourEmploi_m` ON SCHEDULE EVERY 1 DAY STARTS '2017-10-31 02:00:00' ON COMPLETION NOT PRESERVE ENABLE DO DROP TABLE IF EXISTS statsUsersRetourEmploi_m */ ;;
/*!50003 SET time_zone             = @saved_time_zone */ ;;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;;
/*!50003 SET character_set_client  = @saved_cs_client */ ;;
/*!50003 SET character_set_results = @saved_cs_results */ ;;
...
/*!50003 SET @saved_time_zone      = @@time_zone */ ;;
/*!50003 SET time_zone             = 'SYSTEM' */ ;;
/*!50106 CREATE*/ /*!50117 DEFINER=`root_memo`@`%`*/ /*!50106 EVENT `drop_userActivities_m` ON SCHEDULE EVERY 1 DAY STARTS '2017-09-22 01:00:00' ON COMPLETION NOT PRESERVE ENABLE DO DROP TABLE IF EXISTS userActivities_m */ ;;
/*!50003 SET time_zone             = @saved_time_zone */ ;;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;;
/*!50003 SET character_set_client  = @saved_cs_client */ ;;
/*!50003 SET character_set_results = @saved_cs_results */ ;;
...
-- Dump completed on 2018-08-27 17:09:30
