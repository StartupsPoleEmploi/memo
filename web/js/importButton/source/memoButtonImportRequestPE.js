...
MemoButtonImportRequest.prototype = {
    ...
    setButtonState : function(state)
    {
        ...
        {
            this.setParentState("btn-memo-off","Offre enregistrée dans MEMO");
        }
        else if(state=="doublon")
        {
            this.setParentState("btn-memo-off","Vous avez déjà enregistré cette candidature dans MEMO");
        }
    },
