...
MemoButtonToolkit.prototype = {
    ...
    initCss : function()
    {
        ...
        if(!document.getElementById("memoCss"))
        {
            ...
            if(this.envt=="p")
                css.href = "https://memo.pole-emploi.fr/css/importButton/memoButtonMEMO.css";
            else if(this.envt=="loc")
                css.href = "http://localhost/css/importButton/memoButtonMEMO.css";
            else if(this.envt=="r")
                css.href = "https://memo.beta.pole-emploi.fr/css/importButton/memoButtonMEMO.css";
    ...
    buildIframe : function()
    {
        ...
        if(this.envt=="p")
            ifr.setAttribute("src", "https://memo.pole-emploi.fr/importButton/importButtonMEMO.html");
        else if(this.envt=="loc")
        	ifr.setAttribute("src","http://localhost/importButton/importButtonMEMO.html");
        else if(this.envt=="r")
            ifr.setAttribute("src", "https://memo.beta.pole-emploi.fr/importButton/importButtonMEMO.html");
        else
            ifr.setAttribute("src", "http://boomerang:8080/importButton/importButtonMEMO.html");
