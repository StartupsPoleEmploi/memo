        ...
        $.ajax({
            ...
            success: function (response)
            {
                ...
                if(response.result=="ok")
                {
                    ...
                    lBR.buildDisplayAfterLoadingCandidatures();
                }
                else
                {
    ...
    showCandidatureEvents : function(c)
    {
        ...
        for(var i= 0, l=events.length; i<l; ++i)
        {
            ...
            if(e.eventType==CS.TYPES.ENTRETIEN)
            {
                ...
                html+="Archivage. Motif : "+t.eventSubTypes[e.eventSubType];
            else
            ...
            if(e.comment)
                html+= "<div class='todo-tasklist-item-text eventComment'>"+e.comment+"</div>";
            ...
            if(!memoVars.isVisitor)
            {
                ...
                html+="<i id='rmEvt_"+e.id+"' class='eventRemove fa fa-remove' title='Archiver'></i>";
                html+="</div>";
            }
