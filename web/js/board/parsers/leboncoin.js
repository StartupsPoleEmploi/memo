function ParserLeBonCoin()
{
    //console.log("instantiate Le Bon Coin Parser");
}

ParserLeBonCoin.prototype = {
    ...
    parse : function (html) {
        ...
        if(cont.find(key).length>0)
            v += cont.find(key+" div:nth-child(1)").text()+" : "+cont.find(key+" div:nth-child(2)").text()+"\n";
        ...
        try // 2 formats de représentation de l'entreprise. cas d'un block "storebox" ou cas d'un bloc moins identifié
        {
            if(cont.find("[data-qa-id=adview_contact_container] [data-qa-id=storebox_container]").length>0)
            {
                ...
                val = cont.find("[data-qa-id=storebox_siren]").text();
            ...
            else
            {
                ...
                val = cont.find("[data-qa-id=adview_contact_container] div:nth-child(1) div:nth-child(2) div:nth-child(2)").text();
