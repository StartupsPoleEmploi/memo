...
NextEvents.prototype = {
    ...
    getNextActionAdvice : function(c)
    {
        ...
        if (c && !c.archived) {
	        ...
	        if(now.diff(lA,'days')>30)  {     
	            ...
	            res = "<span class='tooltipster' title='Conseil : supprimer'><span class='nextActionTitle'>Conseil :</span> supprimer</span>";
	        } else {
    ...
    openNextAction : function(evt)
    {
        ...
        else if(action=="<span class='tooltipster' title='Conseil : supprimer'><span class='nextActionTitle'>Conseil :</span> supprimer</span>")
        ...
        if(action!="<span class='tooltipster' title='Conseil : supprimer'><span class='nextActionTitle'>Conseil :</span> supprimer</span>") { // Pr simplifier la suppression, le composant commentaire est directement affiché
    ...
    openArchiverCandidature : function()
    {
        ...
        ga('send', {hitType: 'event', eventCategory : 'Candidature', eventAction: 'nextAction', eventLabel: 'Ouverture conseil : supprimer'});
    },
    ...
    archiverCandidature : function()
    {
        ...
        ga('send', {hitType: 'event', eventCategory : 'Candidature', eventAction: 'nextAction', eventLabel: 'Supprimer'});
    },
