    ...
    getUsersAssidus : function()
    {
        ...
        $.ajax({
            ...
            success: function (response)
            {
                ...
                {
                    var tabKeys = response.tabKeys,
                        tabValues = response.tabValues[0],
                        l = tabKeys.length;

                    if(l>13)
                    {
                        tabKeys = tabKeys.slice(l-13);
                        tabValues = tabValues.slice(l-13);
                    }

                    stats.setGraphUsersAssidus(tabKeys, [tabValues]);
        ...
        $.ajax({
            ...
            success: function (response)
            {
                if(response.result=="ok")
                {
                    ...
                    stats.setGraphUsersEntretien(tabKeys, [tabValues]);
        ...
        $.ajax({
            ...
            success: function (response)
            {
                if(response.result=="ok")
                {
                    ...
                    stats.setGraphUsersRetourEmploi(tabKeys, [tabValues]);
