...
if(window.location.hostname.indexOf('boomerang')>=0)
	urlRest="http://boomerang:8080";
else if(window.location.hostname.indexOf('beta')>=0)
	urlRest="https://memo.beta.pole-emploi.fr";
else
	urlRest="https://memo.pole-emploi.fr";
...
function saveCandidature(c)
{
    ...
    if(ok)
    {
        ...
        $.ajax({
            type: 'POST',
            url: urlRest+'/rest/candidatures/importFrom',
            data: p,
            dataType: "json",
...
function importOffre()
{
    ...
    $.ajax({
        type: 'POST',
        url: urlRest+'/rest/candidatures/offre',
        data : p,
        dataType: "html",
