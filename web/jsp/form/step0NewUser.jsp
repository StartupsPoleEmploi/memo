...
<div id="noCardWelcomeMsg" class="formTunnelBloc" style="display:none;">
  ...
  <div>
    ...
    Vous pouvez mémoriser les candidatures que vous avez déjà effectuées ou de nouvelles.<br /><br />
    C’est <strong>simple et rapide</strong>, il suffit de vous laisser guider :</p>
  </div>
  
  <div class="formWelcomeButton">
	 <a id="goToStep1" class="btn green buttonShowCandidatureForm">
	 	<div class="buttonStep0">
	 		<span>Enregistrez une candidature dans votre tableau de bord</span>
	 	</div>
	 </a>
  </div>
