...
<div id="candidatureFormStepProgress" class="formTunnelBloc" style="display:none;">

  <div>
    <div class="pageTitle" style='white-space: normal;word-wrap: break-word;'><h2>Quel est l'avancement de votre candidature ?</h2></div>
  ...
  <div class="newCardButtons formBloc" style="margin-top:40px">
    <div class="formTunnelButton2">
      <button type="button" value="0" class="saveCandidatureTunnel btn  buttonShowCandidatureForm">Je vais postuler</button>
    </div>
    <div class="formTunnelButton2">
      <button type="button" value="1" class="saveCandidatureTunnel btn  buttonShowCandidatureForm">J'ai postulé</button>
    </div>
    <div class="formTunnelButton2">
      <button type="button" value="2" class="saveCandidatureTunnel btn  buttonShowCandidatureForm">J'ai relancé</button>
    </div>
    <div class="formTunnelButton2">
      <button type="button" value="3" class="goToStepEntretien btn  buttonShowCandidatureForm">J'ai un entretien</button>
    </div>
  </div>
