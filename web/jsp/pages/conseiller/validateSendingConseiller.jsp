		...
		<div class="row">
			...
			<div class="col-sm-8">
				<div align="center" class="ctn">
					...
					<img src="../../../pic/conseiller/envoiDemande.png"  /><br><br>
					<strong id="txtMsg"></strong><br><br>
...
<script>
	...
	if (type && type==0) {
		conseiller.logEventToGA('event', 'Conseiller', 'problème envoi mail invitation/demande accès', '');
	}
</script>
