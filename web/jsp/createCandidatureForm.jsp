...
<div id="createCandidatureForm" style="display:none;" class="marginTop60">
    ...
    <div id="candidatureForm" style="display:none;">
        ...
        <div id="formActions" class="formActions">
            ...
            <div id="formActionArchive" class="boutonArchiver tooltipster" title="Archiver la candidature">
                ...
                <div class="form-body">
                    ...
                    <div class="formBloc">
                        ...
                        <div class="form-group">
                            <label for="cdCandidatureName">Titre de la candidature</label>
                    ...
                    <div class="formBloc" id="formBlocSoc">
                        ...
                        <div class="form-group" id="cdUrlSourceRow">
                            <label for="cdUrlSource">Lien Internet de l'offre</label>
                            <div><a href="" id="cdUrlSource" target="_blank"></a></div>
                        </div>

                        <div class="form-group" id="cdNomSocieteRow">
                            <label for="cdNomSociete">Nom de la société</label>
                        ...
                        <div class="form-group" id="cdNumSiretRow">
                            <label for="cdNumSiret">SIRET</label>
                            <div id="cdNumSiret"></div>
                        </div>

                        <div class="form-group" id="cdVilleRow">
                            <label for="cdVille">Lieu</label>
                            <div id="cdVille"></div>
                        </div>

                        <div class="form-group" id="cdContactRow">
                            <label for="cdContactInfo">Personne à contacter</label>
                    ...
                    <div class="formBloc lastFormBloc">
                        ...
                        <div class="form-group">
                            <label for="cdCandidatureType">Type de candidature</label>
                            <div id="cdCandidatureType"></div>
                        </div>

                        <div class="form-group">
                            <label for="cdEtatCandidature">Où en êtes-vous avec cette offre d'emploi ?</label>
                            <div></div>
        ...
        <div class="col-md-8 col-xs-12" id="candidatureFormColumn">
            <form class="form-horizontal" style="margin-top: -10px;">
                <div class="form-body">
                    ...
                    <div id="candidatureFormErrorMessages" class="tfErr" style="display: none;"></div>
