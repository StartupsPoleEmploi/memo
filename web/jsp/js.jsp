...
<pack:script>
    ...
    <src>/js/introjs/intro.min.js</src>
...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-132488599-1"></script>
<script>
    window.dataLayer = window.dataLayer || [];
    function gtag(){dataLayer.push(arguments);}
    gtag('js', new Date());

    gtag('config', 'UA-132488599-1');
</script>
