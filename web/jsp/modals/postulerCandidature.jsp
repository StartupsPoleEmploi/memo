            ...
            <div class="modal-body">
				...
				<div style='padding-left:30px'>
	                ...
	                <ul style="list-style-type: none;">
		                ...
		                <li>&rarr; <a href="http://www.emploi-store.fr/portail/services/bABaCvLettreDeMotivation" target="astuces" onclick="lBR.logEventToGA('event', 'Candidature', 'nextAction', 'Site externe : postuler - B.A BA')">B.A BA CV et lettre de motivation </a>(1h)</li>
	                ...
	                <ul style="list-style-type: none;">
	                	<li>&rarr; <a href="http://www.emploi-store.fr/portail/services/cvPoleEmploi" target="cvpe">CV pôle emploi</a> / <a href="http://www.emploi-store.fr/portail/services/outilDeCreationDeCvDesignPdfGratuit" target="cvDesign" onclick="lBR.logEventToGA('event', 'Candidature', 'nextAction', 'Site externe : postuler - CV design')">CV DesignR</a> / <a href="https://www.canva.com/fr_fr/creer/cv/" target="canva">Canva</a></li>
	                	<li>&rarr; <a href="http://www.emploi-store.fr/portail/services/lettreDeMotivationEnUnClic" target="lm" onclick="lBR.logEventToGA('event', 'Candidature', 'nextAction', 'Site externe : postuler - modèles')">Modèles de lettres de motivation à personnaliser</a></li>
	                </ul>
					Pour aller plus loin :
	                <ul style="list-style-type: none;">
	                	<li>&rarr; <a href="http://www.emploi-store.fr/portail/services/glassdoor" target="cvpe" onclick="lBR.logEventToGA('event', 'Candidature', 'nextAction', 'Site externe : postuler - glassdoor')">Les avis des employés de l’entreprise </a>(Glassdoor)</li>
	                	<li>&rarr; <a href="http://www.emploi-store.fr/portail/services/quiConsulteVotreCv" target="cvpe" onclick="lBR.logEventToGA('event', 'Candidature', 'nextAction', 'Site externe : postuler - tilkee')">Qui consulte votre CV ? </a>(Tilkee)</li>
	                </ul>
				</div>
            </div>
