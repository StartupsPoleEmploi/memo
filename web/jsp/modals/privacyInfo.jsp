...
<div class="modal" id="mdPrivacyInfo" tabindex="-1" role="dialog" aria-labelledby="mdPrivacyInfoDesc">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title" id="mdPrivacyInfoDesc">Accepter la politique de confidentialité</h4>
      </div>
      <div class="modal-body">

        Pour utiliser le service MEMO, vous devez accepter <a>la Politique de confidentialité</a> de MEMO.<br />
