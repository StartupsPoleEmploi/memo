...
class CandidatureRelaunchCandidatureModal extends Component{

    getText()
    {
        return <div>Vous n'avez pas été retenu(e) pour le poste {this.props.candidature.nomCandidature}{this.props.candidature.nomSociete?" au sein de la société "+this.props.candidature.nomSociete:""}.
            <br /><br />
...
export default CandidatureRelaunchCandidatureModal;