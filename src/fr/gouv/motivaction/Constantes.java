...
public class Constantes {
	...
	public static enum TypeOffre { 
		ZERO("ERREUR"), SPONT("SPONTANEE"), OFFRE("OFFRE_EN_LIGNE"), RESEAU("RESEAU"), AUTRE("AUTRE");
	...
	public static enum TypeEvt {ZERO, DOIS_RELANCER, ECHANGE_MAIL, ENTRETIEN, AI_POSTULE, AI_RELANCE, ARCHIVER, RAPPEL, NOTE, MAINTENIR, AI_PREPARE, AI_REMERCIE} 
	
	public static enum TypeSubEvt {ZERO, ENTRETIEN_PHYSIQUE, ENTRETIEN_TEL, ENTRETIEN_VIDEO, REPONSE_NEG, PAS_REPONSE, OFFRE_POURVUE, OFFRE_HORS_LIGNE, INTERESSE_PLUS, 
	...
	public static enum JobBoardUrl {
		POLE_EMPLOI("candidat.pole-emploi.fr"), LEBONCOIN("leboncoin.fr"), INDEED("indeed.fr"), VIVASTREET("vivastreet.com"), MONSTER("monster.fr"),
			...
			JOBALIMVITIJOB("vitijob"), GENERIQUE("generique"), STEPSTONE("stepstone"), MARKETVENTE("marketvente");
