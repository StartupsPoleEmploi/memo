...
import fr.gouv.motivaction.AccountAction;
...
public class PastInterview extends AlertMail {
    ...
    public void execute(JobExecutionContext context) throws JobExecutionException
    {
        ...
        MailService.sendMailReport(Utils.concatArrayString(MailTools.tabEmailIntra, MailTools.tabEmailDev, MailTools.tabEmailExtra), "Rapport " + MailTools.env + " - Que devient votre candidature ?", body);
    }
    ...
    public void sendPastInterview(UserSummary user, String nomCandidature, String nomSociete, Long idCandidature, boolean test)
    {
        ...
        html += "<tr><td style='border-left:1px solid #c1c1c1;border-right:1px solid #c1c1c1; padding:15px 10px; text-align:justify'>" +
                "Bonjour,<br /><br />Il y a 15 jours, vous avez passé un entretien ("+nomCandidature+societe+"). Qu'en est-il de votre candidature ? Avez-vous eu le poste ?";
