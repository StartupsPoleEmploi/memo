...
public class PastInterviewReminder extends AlertMail {
    ...
    public void execute(JobExecutionContext context) throws JobExecutionException
    {
        ...
        MailService.sendMailReport(Utils.concatArrayString(MailTools.tabEmailIntra, MailTools.tabEmailDev, MailTools.tabEmailExtra), "Rapport " + MailTools.env + " - Avez-vous relancé votre candidature ?", body);
    }
    ...
    private String buildAndSendPastInterviewReminder(long userId)
    {
        ...
        try
        {
        	// @RG - EMAIL : la campagne de mail "Avez-vous relancé votre candidature" s'adresse aux utilisateurs notifiables ayant une candidature non archivée avec un rappel de type 'RELANCER ENTRETIEN' ce jour et pour laquelle il n'y a pas déjà eu un evt de type 'AI_REMERCIE'
    ...
    private void sendPastInterviewReminder(UserSummary user, String nomCandidature, String nomSociete, Timestamp eventTime, boolean test)
    {

        String subject = "Avez-vous relancé votre candidature";
        ...
        html+= "<br /><br />Vous y êtes pourtant presque, une des dernières étapes cruciales : relancer votre candidature !<br /><br />" +
                ...
                "<li>évitez les erreurs classiques et suivez tous les autres conseils que vous retrouverez en cliquant sur les boutons \"RELANCER\" dans votre tableau de bord</li>" +
