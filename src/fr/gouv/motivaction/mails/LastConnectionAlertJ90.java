...
public class LastConnectionAlertJ90 extends AlertMail {
    ...
    public void sendLastConnectionAlert(UserSummary user, boolean test)
    {
        ...
        html += "Cela fait trois mois que vous ne vous êtes pas connecté sur MEMO.</td></tr>";

        html += MailTools.getGotAJobButton(user,source,campaign);

        html += "<tr><td style='border-left:1px solid #c1c1c1;border-right:1px solid #c1c1c1; padding:15px 10px; text-align:justify'>" +
                "Si vous êtes toujours en recherche d'emploi, profitez maintenant pleinement de MEMO pour accélérer votre retour à l'emploi !<br />" +
        ...
        html += "Nous vous invitons donc à vous connecter à ce service et à y enregistrer vos candidatures en cours.";
        html += "</td></tr>";
