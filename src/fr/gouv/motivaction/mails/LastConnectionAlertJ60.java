...
public class LastConnectionAlertJ60 extends AlertMail {
    ...
    public void execute(JobExecutionContext context) throws JobExecutionException
    {
        ...
        MailService.sendMailReport(Utils.concatArrayString(MailTools.tabEmailIntra, MailTools.tabEmailDev, MailTools.tabEmailExtra), "Rapport " + MailTools.env + " - Reprenez le fil de vos candidatures", body);
    }
    ...
    private void sendLastConnectionAlert(UserSummary user, boolean test)
    {
        ...
        html += "Vous n'avez pas mis à jour votre tableau de bord MEMO depuis un moment ?<br />" +
                "Ce n'est pas grave, le mettre à jour vous permettra de reprendre le fil et de suivre les conseils de MEMO sur chacune de vos candidatures (relancer un recruteur, se préparer à un entretien…)<br /><br />";
        
        html += "</td></tr>";


        html += MailTools.buildHTMLSignature(source,campaign, "Visualiser toutes mes candidatures dès maintenant", false);
