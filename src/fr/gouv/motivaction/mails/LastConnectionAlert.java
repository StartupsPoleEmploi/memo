...
public class LastConnectionAlert extends AlertMail {
    ...
    public void execute(JobExecutionContext context) throws JobExecutionException
    {
        ...
        MailService.sendMailReport(Utils.concatArrayString(MailTools.tabEmailIntra, MailTools.tabEmailDev, MailTools.tabEmailExtra), "Rapport " + Constantes.env + " - Où en êtes-vous de votre recherche d'emploi ?", body);
    }
    ...
    {
        String subject = "Où en êtes-vous de votre recherche d'emploi ?";
        ...
        html += "Cela fait un mois que vous ne vous êtes pas connecté sur MEMO.</td></tr>";
        
        html += MailTools.getGotAJobButton(user,source,campaign);

        html += "<tr><td style='border-left:1px solid #c1c1c1;border-right:1px solid #c1c1c1; padding:15px 10px; text-align:justify'>Si vous êtes toujours en recherche d'emploi, profitez maintenant pleinement de MEMO pour accélérer votre retour à l'emploi !<br />" +
        ...
        html += "Je vous invite donc à vous connecter à ce service et à y enregistrer vos candidatures en cours.";
        html += "</td></tr>";
