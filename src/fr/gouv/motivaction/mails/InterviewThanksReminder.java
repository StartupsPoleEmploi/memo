...
public class InterviewThanksReminder extends AlertMail {
    ...
    public void execute(JobExecutionContext context) throws JobExecutionException
    {
        ...
        MailService.sendMailReport(Utils.concatArrayString(MailTools.tabEmailIntra, MailTools.tabEmailDev, MailTools.tabEmailExtra), "Rapport " + MailTools.env + " - Avez-vous pensé à remercier après votre entretien ?", body);
    }
