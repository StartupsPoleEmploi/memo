...
public class AttachmentService {
    ...
    public static String[] authorizedFilesMimeType;
    ...
    private static void loadProperties()
    {
        ...
        try
        {
            ...
            authorizedFilesMimeType = StringTokenizerUtils.tokenizeToArray(prop.getProperty("authorizedFilesMimeType"), " ;");
    ...
    public static long storeFile(long userId, long candidatureId, String fileName, String fileType, String fileData) throws Exception
    {
        ...
        if(isMimeTypeOK(fileType))
        {
            ...
            throw new Exception("Attachment Mime Type not authorized. MimeType="+fileType+" fileName="+fileName);
    ...
    public static boolean isMimeTypeOK(String fileType)
    {
        boolean result = false;

        if(fileType.equals("") || ArrayUtils.indexOf(authorizedFilesMimeType, fileType.toLowerCase())>-1)
            result = true;
    ...
    public static boolean checkForVirus(Attachment att, byte[] fileByteData) throws Exception
    {
        ...
        {
            log.error(logCode+"-006 ATTACHMENT Clamav error. userId="+att.getUserId() + " candidatureId=" + att.getCandidatureId()+" fileName=" + att.getFileName()+" error="+e);
            throw new Exception(e);
        }
