...
public class APIService {
    ...
    private static void loadProperties()
    {
        ...
        try
        {
			...
			if(MailTools.env.equals("RECETTE"))
				memoHost = prop.getProperty("memoHost.recette");
			else if(MailTools.env.equals("LOCAL"))
				memoHost = prop.getProperty("memoHost.local");
			else
				memoHost = prop.getProperty("memoHost.production");
