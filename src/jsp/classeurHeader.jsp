        ...
        <div class="container-fluid">
            <div class="havbar-header">
                ...
                <div class="topbar-actions">
                    ...
                    <div class="btn-group-img btn-group marginBeta">
						
                        <a class="btn btn-sm dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true"><i class="fa fa-navicon fa-2x marginMenu"></i><div>Menu</div></a>
