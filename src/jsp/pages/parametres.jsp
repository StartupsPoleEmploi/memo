	            ...
	            <div class="form-body">
					...
					<div class="formBloc">
	                	...
	                	<div class="form-group" id="changePasswordBlock">
		                    <label class="col-md-5 col-sm-6 col-xs-12 control-label">Pour modifier votre mot de passe :</label>
						...
						<div class="form-group">
							<label class="col-md-5 col-sm-6 col-xs-12 control-label">Pour modifier votre adresse e-mail :</label>
							<div class="col-md-5 col-sm-6 col-xs-4 ">
								<div class="visible-xs"><br /></div>
		                ...
		                <div class="form-group">
		                	<label class="col-md-5 col-sm-6 col-xs-12 control-label">Pour supprimer définitivement votre compte : </label>
							<div class="col-md-5 col-sm-6 col-xs-4 ">
								<div>
									<div class="visible-xs"><br /></div>
					...
					<div class="formBloc">
	                	...
	                	<div class="form-group" id="extractTDBBlock">
		                    <label class="col-md-5 col-sm-6 col-xs-12 control-label">Vous pouvez exporter les données de votre tableau de bord dans un format compatible avec les tableurs dont Excel et Open Office Calc</label>
		                    <div class="col-md-5 col-sm-6 col-xs-4 ">
								<div class="visible-xs"><br /></div>
